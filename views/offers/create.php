<div class="container" id="create_form">
    ...
    <form action="/offers/create" id="create_offer" method="post" class="form-horizontal" autocomplete="off">
        ...
        <div class="form-group min_amount-group">
            ...
            <div class="col-sm-10">
                <input name="min_amount" type="number" step="1" class="form-control" id="min_amount"
        ...
        <div class="form-group max_amount_group">
            ...
            <div class="col-sm-10">
                <input name="max_amount" type="number" step="1" class="form-control" id="max_amount"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <p class="help-block">
                    <?php
                    if (isset($this->newMaxOfferBtcAmount) && isset($this->newMinOfferBtcAmount)) {
                        echo "Max: " . $this->newMaxOfferBtcAmount . " BTC / Min: " . $this->newMinOfferBtcAmount . " BTC";
                    } else {
                        echo "0 BTC";
                    } ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select class="form-control selectpicker" name="payment_method_group" id="payment_method_group"
                        data-live-search="true" data-title="Payment Method Group" data-header="Payment Method Group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select class="form-control selectpicker" name="payment_method" id="payment_method"
                        data-live-search="true" data-title="Payment Method" data-header="Payment Method">
